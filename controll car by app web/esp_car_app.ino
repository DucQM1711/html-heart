...
const int buzPin = 13;      // set digital pin D5 as buzzer pin (use active buzzer)
...
String sta_ssid = "Sylassss";      // set Wifi networks you want to connect to
String sta_password = "23102004";  // set password for Wifi networks
